...
public class Task1_4 {
    ...
    private static final String CONST_MSG_NAME = "muroi";
    private static final String CONST_MSG_PASS = "password";
    ...
    public static void main(String[] args) {
        ...
        else if (name.equals("alice") && pass != CONST_MSG_PASS) {
            System.out.println(CONST_MSG_ERROR_PASS);
        }

        // ④ パスワードのみ正しい場合、「 名前に誤りがあります。 」と出力してください。
        else if (name != CONST_MSG_NAME && pass.equals("pass")){
